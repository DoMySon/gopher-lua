...
.. image:: https://pkg.go.dev/badge/lua.svg
    :target: https://pkg.go.dev/lua

.. image:: https://lua/workflows/test/badge.svg?branch=master&event=push
    :target: https://lua/actions?query=workflow:test
...
There are some benchmarks on the `wiki page <https://lua/wiki/Benchmarks>`_ .
...
Refer to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ and `Go doc <http://godoc.org/lua>`_ for further information.

Note that elements that are not commented in `Go doc <http://godoc.org/lua>`_ equivalent to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ , except GopherLua uses objects instead of Lua stack indices.
...
Refer to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ and `Go doc(LState methods) <http://godoc.org/lua>`_ for further information.
...
Refer to `Go doc(LState methods) <http://godoc.org/lua>`_ for further information.
...
How to Contribute
----------------------------------------------------------------
See `Guidelines for contributors <https://lua/tree/master/.github/CONTRIBUTING.md>`_ .
